...
2. [Partie 1: Détection des Stades Phénologiques](#2-partie-1-détection-des-stades-phénologiques)
   2-1. [Description du modèle CNN](#description-du-modèle-cnn)
   2-2. [Prétraitement des données](#prétraitement-des-données)
   2-3. [Entraînement et évaluation](#entrainement-et-évaluation)
   2-4. [Exportation du modèle en TensorFlow Lite](#exportation-du-modèle-en-tensorflow-lite)
